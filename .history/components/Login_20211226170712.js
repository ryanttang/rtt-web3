...
function Login() {
    ...
    return (
      ...
      <form className="flex flex-col justify-center items-center w-1/2">
        ...
        <a
          href="#"
          className="bg-yellow-500 py-3 px-20 bg-primarycolor rounded-full text-white font-bold uppercase text-lg mt-4 transform hover:translate-y-1 transition-all duration-500"
          >Login</a>
      </form>
    </div>
