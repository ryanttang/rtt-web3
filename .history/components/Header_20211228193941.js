...
function Header() {
    ...
    return (
        <><header className="absolute w-24 h-16 bg-white shadow-md transition lg:h-20">
            <nav className="container m-auto py-3 lg:px-20 lg:py-4">
                <div classNameName="relative flex flex-wrap items-center justify-between">
                    <div className="relative z-10 w-24 px-6 flex items-center justify-between lg:w-auto">
                    <Image
                            layout="fill"
                            objectFit="contain"
        ...
        <div className="sticky top-20 p-5 z-50 bg-white shadow-sm border-b-2 border-black text-blue-500">
