...
function Login() {
    ...
    return (
      ...
      <div className="max-w-sm mx-auto my-24 bg-white px-5 py-10 rounded shadow-xl opacity-90">
           {/* Logo */}
           <Image 
        ...
        <div className="text-center mb-8 mt-8">
          <h1 className="font-bold text-2xl font-bold text-black">Welcome To Your Collection</h1>
        </div>
        <form action="#">
