    ...
    return (
      ...
      <div className="max-w-sm mx-auto my-24 bg-white px-5 py-10 rounded shadow-xl">
        <div className="text-center mb-8">
          <h1 className="font-bold text-2xl font-bold text-black">Login To Collection</h1>
        </div>
        <form action="#">
          ...
          <div className="mt-10">
            <input
              ...
              type="submit"
              value="Login"
              className="py-3 bg-yellow-500 hover:bg-green-600 rounded text-white text-center w-full animate-pulses"
            />
          </div>
        </form>
      </div>
