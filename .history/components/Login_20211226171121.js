...
function Login() {
    ...
    return (
      ...
      <Image
        ...
        className="lg:block w-1/2 hover:scale-150 transition-all duration-500 transform mx-auto z-50" 
        width={200}
        height={200}
            />
      <form className="flex flex-col justify-center items-center w-1/2">
        ...
        <div className="relative">
          <i className="fa fa-user absolute text-black text-xl"></i>
          <input
            type="text"
        ...
        <div className="relative mt-8">
          <i className="fa fa-lock absolute text-black text-xl"></i>
          <input
            type="password"
        ...
        <a href="#" className="self-center mt-4 text-gray-600 font-bold"
          >Forgot password?</a>
        <a
          href="#"
          className="bg-yellow-500 py-3 px-20 bg-primarycolor rounded-lg text-white font-bold uppercase text-lg mt-4 transform hover:translate-y-1 transition-all duration-500"
          >Login</a>
      </form>
    </div>
