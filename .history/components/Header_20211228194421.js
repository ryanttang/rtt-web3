...
function Header() {
    ...
    return (
        <><header className="relative w-full h-16 bg-white shadow-md transition lg:h-20">
        ...
        <div className="sticky top-18 p-5 z-50 bg-white shadow-sm border-b-2 border-black text-blue-500">
