...
function Login() {
    ...
    return (
      ...
      <div className="max-w-sm mx-auto my-24 bg-white px-5 py-10 round shadow-xl opacity-90">
           {/* Logo */}
           <Image 
        ...
        <form action="#">
          ...
          <div className="w-full mt-10 item-center">
            <input
              onClick={authenticate}
              type="submit"
              value="Login with Wallet"
              className="py-3 bg-yellow-500 hover:bg-green-600 rounded text-white text-center w-50 animate-pulse"
            />
          </div>
        </form>
      </div>
